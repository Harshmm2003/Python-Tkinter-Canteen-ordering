...
from dessert import *
from PIL import Image, ImageTk #pillow library for inserting images in the window
def menu():
    root = Tk()
    ...
    img = ImageTk.PhotoImage(Image.open(IMAGE_PATH).resize((1000,700), Image.ANTIALIAS))
